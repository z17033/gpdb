...
-- #define MPP_EXECUTION_SEGMENT_TYPE 23
 ...
 CREATE FUNCTION __gp_operate_endpoints_token(IN operation char, IN tokenstr cstring, IN cursorname cstring, OUT success bool) RETURNS bool LANGUAGE internal VOLATILE STRICT EXECUTE ON ANY AS 'gp_operate_endpoints_token' WITH (OID=7180, DESCRIPTION="operation on endpoints entries");
