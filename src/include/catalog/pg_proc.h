...
DATA(insert OID = 2511 (  pg_cursor PGNSP PGUID 12 1 1000 0 0 f f f f t t s r 0 0 2249 "" "{25,25,16,16,16,16,1184}" "{o,o,o,o,o,o,o}" "{name,statement,is_holdable,is_binary,is_scrollable,is_parallel_retrieve,creation_time}" _null_ _null_ pg_cursor _null_ _null_ _null_ ));
