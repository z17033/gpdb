...
/* gp_endpoints_info(IN isall bool, OUT token text, OUT cursorname text, OUT sessionid int4, OUT hostname text, OUT port int4, OUT dbid int4, OUT userid oid, OUT status text, OUT endpointname text) => SETOF record */
DATA(insert OID = 7178 ( gp_endpoints_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 1 0 2249 "16" "{16,25,25,23,25,23,23,26,25,25}" "{i,o,o,o,o,o,o,o,o,o}" "{isall,token,cursorname,sessionid,hostname,port,dbid,userid,status,endpointname}" _null_ _null_ gp_endpoints_info _null_ _null_ _null_ n m ));
DESCR("mpp endpoints information");

/* gp_endpoints_status_info(OUT token text, OUT databaseid int4, OUT senderpid int4, OUT receiverpid int4, OUT status text, OUT dbid int4, OUT sessionid int4, OUT userid oid, OUT endpointname text, OUT cursorname text) => SETOF record */
DATA(insert OID = 7179 ( gp_endpoints_status_info  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" "{25,23,23,23,25,23,23,26,25,25}" "{o,o,o,o,o,o,o,o,o,o}" "{token,databaseid,senderpid,receiverpid,status,dbid,sessionid,userid,endpointname,cursorname}" _null_ _null_ gp_endpoints_status_info _null_ _null_ _null_ n a ));
DESCR("endpoints status information");

/* __gp_operate_endpoints(IN operation char, IN tokenstr cstring, IN cursorname cstring, OUT success bool) => bool */
DATA(insert OID = 7180 ( __gp_operate_endpoints  PGNSP PGUID 12 1 0 0 0 f f f f t f v 3 0 16 "18 2275 2275" "{18,2275,2275,16}" "{i,i,i,o}" "{operation,tokenstr,cursorname,success}" _null_ _null_ gp_operate_endpoints _null_ _null_ _null_ n a ));
DESCR("operation on endpoints entries");

/* gp_check_parallel_retrieve_cursor(IN cursorname cstring, OUT finished bool) => bool */
DATA(insert OID = 7181 ( gp_check_parallel_retrieve_cursor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 16 "2275" "{2275,16}" "{i,o}" "{cursorname,finished}" _null_ _null_ gp_check_parallel_retrieve_cursor _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7182 ( gp_wait_parallel_retrieve_cursor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 16 "2275" "{2275,16}" "{i,o}" "{cursorname,finished}" _null_ _null_ gp_wait_parallel_retrieve_cursor _null_ _null_ _null_ n a ));
