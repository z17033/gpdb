...
DATA(insert OID = 7180 ( gp_check_parallel_retrieve_cursor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 16 "2275" "{2275,16}" "{i,o}" "{cursorname,finished}" _null_ _null_ gp_check_parallel_retrieve_cursor _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7181 ( gp_wait_parallel_retrieve_cursor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 16 "2275" "{2275,16}" "{i,o}" "{cursorname,finished}" _null_ _null_ gp_wait_parallel_retrieve_cursor _null_ _null_ _null_ n a ));
